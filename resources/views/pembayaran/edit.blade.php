            ...
            <div class="card-body">
                ...
                <form action="{{ route('pembayaran.update', $pembayaran->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $pembayaran->transaksi->kode_transaksi }}"
                            readonly>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $pembayaran->transaksi->pelanggan->nama }}"
                            readonly>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="total_harga" class="form-control"
                            value="Rp{{ number_format($pembayaran->transaksi->total_harga, 0, ',', '.') }}" readonly>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="metode_pembayaran" class="form-select" required>
                            ...
                            <option value="credit" {{ $pembayaran->metode_pembayaran == 'credit' ? 'selected' : '' }}>Credit
                            </option>
                            <option value="debit" {{ $pembayaran->metode_pembayaran == 'debit' ? 'selected' : '' }}>Debit
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="jumlah_bayar" id="jumlah_bayar" class="form-control" min="0"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kembalian" id="kembalian" class="form-control"
                            value="Rp{{ number_format($pembayaran->kembalian, 0, ',', '.') }}" readonly>
                    </div>

                    ...
                    <table class="table table-bordered table-hover align-middle">
                        ...
                        <tbody>
                            @forelse ($pembayarans as $pembayaran)
                                <tr>
                                    <td>{{ $loop->iteration + ($pembayarans->currentPage() - 1) * $pembayarans->perPage() }}
                                    </td>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-{{ $pembayaran->metode_pembayaran == 'cash' ? 'success' : ($pembayaran->metode_pembayaran == 'credit' ? 'warning' : 'info') }}">
